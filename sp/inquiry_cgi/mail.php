...
//変換後の文字
$replaceStr['after'] = array('平米','平方センチメートル','(3)','(4)','(5)','(6)','(7)','(8)','(9)','(10)','No.','（有）','（株）','高');
...
<html lang="ja">
  <head>
    ...
    <link rel="stylesheet" href="css/style.css?4" type="text/css" media="all" />
    <!--[if IE 6]>
...
<?php }else{ ?>
<h3>確認画面</h3>
<p align="center">以下の内容で間違いがなければ、「送信する」ボタンを押してください。</p><br>
<?php iniGetAddMailXHeader($iniAddX);//php.ini設定チェック?>
<form action="<?php echo h($_SERVER['SCRIPT_NAME']); ?>" method="POST">
<table class="formTable">
<?php echo confirmOutput($_POST);//入力内容を表示?>
</table>
<p align="center" class="btnConf"><input type="hidden" name="mail_set" value="confirm_submit">
